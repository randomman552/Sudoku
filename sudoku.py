...
class tile(object):
    ...
    def __init__(self, position, tileSize, tileColor, window, value=None, MinMax=(0, 10)):
        self.value = value
...
class tileGroup(object):
    ...
    def __init__(self, position, tileSize, tileColor, window):
        ...
        self.tiles = [tile((x + 1, y + 1), tileSize - 2, tileColor, window) for x in range(position[0],
        ...
        self.rows = [[self.tiles[pos] for pos in range(row,9,3)] for row in range(3)]
        ...
        self.collumns = [[self.tiles[pos] for pos in range(collumn,collumn+3,1)] for collumn in range(0,9,3)]
...
class game(object):
                ...
                for collumn in tileGroup.collumns:
                    for tile in collumn:
                        ...
                        if tile.position[0] in storageDict["collumns"]:
                            storageDict["collumns"][tile.position[0]].append(tile)
                        #Otherwise, create the list
                        else:
    ...
    def __keyHandler(self):
        ...
        if tile != None:
            ...
            if not(keyStates[pygame.K_RETURN]):
                ...
                keyList = [-1, pygame.K_1, pygame.K_2, pygame.K_3, pygame.K_4, pygame.K_5, pygame.K_6, pygame.K_7, pygame.K_8, pygame.K_9]
    ...
    def __validateTile(self, tile):
        ...
        def validate(tile, checking):
            ...
            Returns True for a validated file, and False otherwise."""
